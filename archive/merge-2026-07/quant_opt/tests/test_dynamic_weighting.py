...
def test_icir_decay_basic():
    from quant_opt.dynamic_weighting import icir_decay_weights
    ic = _make_ic_history()
...
def test_softmax_ic_weights():
    from quant_opt.dynamic_weighting import softmax_ic_weights
    ic = _make_ic_history()
...
def test_empty_history():
    from quant_opt.dynamic_weighting import icir_decay_weights, softmax_ic_weights
    empty = pd.DataFrame()
