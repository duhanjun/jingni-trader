...
def test_icir_decay_basic():
    from skills.quant_optimizations.quant_opt_20260616_core.dynamic_weighting import icir_decay_weights
    ic = _make_ic_history()
...
def test_softmax_ic_weights():
    from skills.quant_optimizations.quant_opt_20260616_core.dynamic_weighting import softmax_ic_weights
    ic = _make_ic_history()
...
def test_dynamic_weighting_class():
    from skills.quant_optimizations.quant_opt_20260616_core.dynamic_weighting import DynamicFactorWeighting
    ic = _make_ic_history()
...
def test_empty_history():
    from skills.quant_optimizations.quant_opt_20260616_core.dynamic_weighting import icir_decay_weights, softmax_ic_weights
    empty = pd.DataFrame()
