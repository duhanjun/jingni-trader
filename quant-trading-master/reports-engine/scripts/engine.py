...
class ReportGenerator:
    ...
    def __init__(self, title: str = REPORT_TITLE):
        self.title = title
        self.charts: List[str] = []  # 存储 HTML chart 片段
...
"""]
        ...
        html_parts.append(f'<div class="footer">Generated by quant-trading-master</div></body></html>')
...
def run(ctx) -> Dict[str, Any]:
    ...
    参数:
        ctx: Context 对象，需包含所有上游产物路径

    返回:
        {
            "success": bool,
            "artifact_path": str,         # HTML 报告路径
            "metadata": {
                "metrics": {...},
                "report_data_path": str,  # JSON 数据路径
            },
            "error": str
        }
    """
