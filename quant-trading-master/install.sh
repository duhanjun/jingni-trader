...
PROJECT_NAME="quant-trading-master"
...
install_skills() {
    ...
    # 复制所有Skill
    for skill_dir in quant-trading-master a-share-data-engine a-share-factor-engine \
...
main() {
    ...
    echo "  3. 运行示例: python3 -m quant_trading_master.scripts.engine"
    echo ""
}
